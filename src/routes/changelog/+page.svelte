...
<div class="custom-scroll h-screen overflow-y-scroll bg-zinc-800 pb-8">
  ...
  <div
    class="prose-a:text-accent-500 prose prose-sm prose-zinc prose-invert prose-strong:text-gray-200 prose-em:text-gray-200 prose-headings:text-gray-200 prose-img:-my-2 prose-img:rounded-md prose-img:border prose-img:border-zinc-600 prose-img:shadow-md mx-14 my-6 tracking-tight text-gray-200"
  >
