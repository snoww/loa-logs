...
<div class="custom-scroll h-screen overflow-y-scroll bg-zinc-800 pb-8">
  ...
  <div class="mx-8 my-4 tracking-tight text-gray-200">
    <p class="px-4 text-base">
      ...
      >), written in Rust by
      <a class="text-accent-500 hover:underline" href="https://github.com/snoww" target="_blank">Snow</a>. This project
      is an opinionated flavor of
      <a class="text-accent-500 hover:underline" href="https://github.com/lost-ark-dev/loa-details" target="_blank"
        >LOA Details</a
      >
