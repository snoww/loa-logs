            ...
            <TabItem title="Live Meter" activeClasses="p-4 text-accent-500 border-b border-accent-500" inactiveClasses="p-4 hover:text-gray-200 text-gray-400">
                <div class="flex flex-col space-y-4 divide-y-[1px]">
                    <div class="mt-4 px-2 flex flex-col space-y-2">
                        ...
                        <SettingItem name="Support Buff %" description="Show the percentage of damage buffed by support" bind:setting={$settings.meter.percentBuffBySup} />
                        <SettingItem name="Support Brand %" description="Show the percentage of damage buffed by support's brand skill (e.g. Bard's Sound Shock)" bind:setting={$settings.meter.percentBrand} />
                    ...
                    <div class="pt-4">
                        ...
                        <div class="mt-4 px-2 flex flex-col space-y-2">
                            ...
                            <SettingItem name="Support Buff %" description="Show the percentage of damage of the skill buffed by support" bind:setting={$settings.meter.breakdown.percentBuffBySup} />
            ...
            <TabItem title="Logs" activeClasses="p-4 text-accent-500 border-b border-accent-500" inactiveClasses="p-4 hover:text-gray-200 text-gray-400">
                <div class="flex flex-col space-y-4 divide-y-[1px]">
                    <div class="mt-4 px-2 flex flex-col space-y-2">
                        ...
                        <SettingItem name="Support Buff %" description="Show the percentage of damage buffed by support" bind:setting={$settings.logs.percentBuffBySup} />
                        <SettingItem name="Support Brand %" description="Show the percentage of damage buffed by support's brand skill (e.g. Bard's Sound Shock)" bind:setting={$settings.logs.percentBrand} />
                    ...
                    <div class="pt-4">
                        ...
                        <div class="mt-4 px-2 flex flex-col space-y-2">
                            ...
                            <SettingItem name="Support Buff %" description="Show the percentage of damage of the skill buffed by support" bind:setting={$settings.logs.breakdown.percentBuffBySup} />
                ...
                <div class="flex flex-col space-y-4 divide-y-[1px]">
                    <div class="mt-4 px-2 flex flex-col space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex space-x-2 items-center">
                                <select id="modifiers" bind:value={$settings.shortcuts.pauseSession.modifier} class="border text-sm rounded-lg block w-20 p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-accent-500 focus:border-accent-500">
                                    <option value="Ctrl">Ctrl</option>
                                    <option value="Alt">Alt</option>
                                    <option value="Shift"><kbd>Shift</kbd></option>
                                </select>
                                ...
                                <select id="keys" bind:value={$settings.shortcuts.pauseSession.key} class="border text-sm rounded-lg block p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-accent-500 focus:border-accent-500">
                                    {#each keys as key}
                                        <option value={key}>{key.toUpperCase()}</option>
                                    {/each}
                                </select>
