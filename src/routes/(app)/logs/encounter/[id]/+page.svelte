  ...
  <div class="sticky top-0 z-50 flex h-16 w-full items-center bg-zinc-800 px-8 shadow-md">
    ...
    <div class="flex items-center justify-between" style="width: calc(100vw - 7.5rem);">
      <div class="flex items-center truncate pl-1 text-xl tracking-tighter">
        <button use:tooltip={{ content: `${fav ? "Remove from" : "Add to"} Favorites` }} onclick={toggle_favorite}>
          {#if fav}
          ...
          {:else}
            <svg class="size-7 fill-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
              ><path
                d="m321-202.5 159-95 159 96-42.5-180 140-121.5L552-519.5l-72-170-71.505 169.676L224-504l140 121-43 180.5Zm-86 120 64.5-279.093L83-549l286-25 111-263 111.5 263L877-549 660.484-361.593 725.436-82.5 480.218-230.61 235-82.5Zm245-353Z"
              /></svg
            >
          {/if}
        </button>
