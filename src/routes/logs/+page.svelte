...
<div class="bg-zinc-800 h-screen">
    <div class="px-8 pt-5">
        <div class="flex justify-between">
            ...
            <button class="px-2 rounded-md bg-blue-900 hover:bg-blue-800 mr-4" on:click={() => refresh()}>
                Refresh
            </button>
        </div>
                ...
                <tbody class="tracking-tight bg-neutral-800">
                    ...
                    {#each encounters as encounter (encounter.fightStart)}
                        <tr class="border-b border-gray-700">
                            ...
                            <td class="px-3 py-3 font-bold text-gray-300">
                                <button class="truncate hover:underline">
                                    {encounter.bossName}
                                </button>
                            </td>
                            <td class="px-3 py-3">
            ...
            <ul class="inline-flex items-center -space-x-px">
                <li>
                    <button class="block px-3 ml-0" on:click={() => firstPage()}>
                        ...
                        <svg class="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="M226 837V314.5h91.5V837H226Zm459.5-3.5L431 579l254.5-254.5 65.5 65L561.5 579 751 768.5l-65.5 65Z"/></svg></button>
                </li>
                <li>
                    <button class="block px-3 ml-0" on:click={() => previousPage()}>
                        <span class="sr-only">First</span>
                        <svg class="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="m560.5 837-262-262 262-262 65 65.5L429 575l196.5 196.5-65 65.5Z"/></svg></button>
                </li>
                <li>
                    <button class="block px-3 ml-0" on:click={() => nextPage()}>
                        <span class="sr-only">First</span>
                        <svg class="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="m375.5 837-65-65.5L507 575 310.5 378.5l65-65.5 262 262-262 262Z"/></svg></button>
                </li>
                <li>
                    <button class="block px-3 ml-0" on:click={() => lastPage()}>
                        <span class="sr-only">First</span>
                        <svg class="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="m273.5 831.5-65.5-65 191-191-191-191 65.5-65 256 256-256 256ZM643 837V314.5h91.5V837H643Z"/></svg></button>
                </li>
            </ul>
        </div>
    </div>
