        ...
        <div
            ...
            <table class="w-full table-fixed text-left text-gray-400" id="table">
                ...
                <tr>
                    ...
                    <th scope="col" class="hidden w-24 px-3 py-3 lg:table-cell text-right">
                        <button class="hover:text-accent-500 flex items-center ml-auto"
                    ...
                    <th scope="col" class="w-14 px-3 py-3">
                        <button class="hover:text-accent-500 flex items-center" on:click={() => setSort("duration")}>
                            DUR
                            {#if $searchFilter.sort === "duration"}
                                {#if $searchFilter.order === 2}
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-gray-400 ml-1"
                ...
                {#each encounters as encounter (encounter.fightStart)}
                    <tr class="border-b border-gray-700 hover:bg-zinc-700" id="encounter-{encounter.id}">
                        ...
                        <td class="hidden truncate px-3 py-3 lg:table-cell">
                            <div class="text-right pr-1" use:tooltip={{ content: encounter.myDps.toLocaleString() }}>
