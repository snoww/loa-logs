<div class="rounded-md flex space-x-2 items-center">
  <div class="text-lg font-semibold text-white">
    v1.43.0-Nineveh Beta 11 - April 27th, 2026
  </div>
...
- fixed dps support specs getting misclassified
- fixed meter not tracking when player dc from raid
- added more contribution data
