  ...
  {#if $settings.general.constantLocalPlayerColor}
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        ...
        />
        <button class="rounded-md bg-zinc-600 p-1 text-xs hover:bg-zinc-700" onclick={() => resetDefaultColor("Local")}
          >Reset
        </button>
      </div>
    </div>
      ...
      <div class="flex items-center justify-between">
        <div>
          <div class="flex items-center space-x-1">
            <img class="size-8" src={$classIconCache[classNameToClassId[classColor[0]] || 0]} alt={classColor[0]} />
