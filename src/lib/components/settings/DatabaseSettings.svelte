        ...
        <div id="modal" class="flex-1 space-y-6 overflow-y-auto overscroll-contain p-6">
          <div class="text-center">
            ...
            {#if !deleteInProgress}
              <button
                type="button"
                class="focus:outline-hidden mr-2 inline-flex items-center justify-center rounded-lg bg-red-700 px-5 py-2.5 text-center text-sm text-white hover:bg-red-800"
                onclick={deleteFn}
              >
                Yes, I'm sure
              </button>
              <button
                type="button"
                class="focus:outline-hidden inline-flex items-center justify-center rounded-lg bg-gray-800 bg-transparent px-5 py-2.5 text-center text-sm text-gray-400 hover:bg-zinc-700 hover:text-white focus:text-white"
                onclick={() => (deleteConfirm = false)}
              >
                No, cancel
              </button>
