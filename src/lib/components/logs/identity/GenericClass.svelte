...
<div class="relative top-0 px">
    ...
    <div class="mt-4">
        ...
        <div>
            Identity per min: <span class="font-bold">{(identityStats.average / 100 * 60).toFixed(1)} per min</span>
        </div>
    </div>
    {/if}
    <div class="mt-4">
        ...
        <div class="h-[200px] mt-2" use:chartable={identityLogOptions} style="width: calc(100vw - 4.5rem);">
        </div>
    </div>
</div>
