        ...
        {#if !$takingScreenshot}
            <div
                ...
                class="flex items-center space-x-px {$settings.meter.showTimeUntilKill
                    ? 'max-[499px]:hidden'
                    : 'max-[419px]:hidden'}">
                <button class="" onclick={openMostRecentEncounter}>
                ...
                <button onclick={resetSession} use:menuTooltip={{ content: "Reset Session" }}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 96 960 960"
                ...
                <button use:menuTooltip={{ content: "Manual Save" }} onclick={saveSession}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <button use:menuTooltip={{ content: "Take Screenshot" }} onclick={screenshotFn}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 -960 960 960"
