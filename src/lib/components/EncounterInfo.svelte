        ...
        <div data-tauri-drag-region class="flex space-x-px items-center max-[419px]:hidden">
            <button class="" on:click={openLogWindow}>
                <div use:menuTooltip={{content: 'Open Recent'}}>
                    <svg class="w-5 h-5 fill-gray-400 hover:fill-gray-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="M475.946 956.5Q316 956.5 206.545 845.323 97.091 734.147 98.5 574.5H190q1.152 120.8 83.513 205.65Q355.873 865 475.825 865q120.675 0 206.425-85.834Q768 693.331 768 571.184q0-119.148-85.937-201.666Q596.127 287 475.5 287q-59.675 0-112.087 24Q311 335 270.5 376H353v70.5H129.5V225H198v94.5q54-58 125.194-91.5 71.195-33.5 152.456-33.5 78.85 0 148.632 30.13 69.782 30.13 122.49 81.511 52.709 51.381 82.718 120.054 30.01 68.673 30.01 147.739t-30.01 148.805q-30.009 69.739-82.5 121.75Q694.5 896.5 624.76 926.5q-69.74 30-148.814 30Zm123.554-214L448 592.565V375.5h68.5v187L650 692l-50.5 50.5Z"/></svg>
                </div>
            </button>
                ...
                <div class="absolute top-6 right-2 z-50 bg-zinc-700 rounded-md shadow-md">
                    <div class="flex flex-col space-y-px p-1 text-gray-400">
                        <button class="hover:text-gray-50" on:click={openLogWindow}>
                            <div class="flex space-x-1">
                                <svg class="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960"><path d="M475.946 956.5Q316 956.5 206.545 845.323 97.091 734.147 98.5 574.5H190q1.152 120.8 83.513 205.65Q355.873 865 475.825 865q120.675 0 206.425-85.834Q768 693.331 768 571.184q0-119.148-85.937-201.666Q596.127 287 475.5 287q-59.675 0-112.087 24Q311 335 270.5 376H353v70.5H129.5V225H198v94.5q54-58 125.194-91.5 71.195-33.5 152.456-33.5 78.85 0 148.632 30.13 69.782 30.13 122.49 81.511 52.709 51.381 82.718 120.054 30.01 68.673 30.01 147.739t-30.01 148.805q-30.009 69.739-82.5 121.75Q694.5 896.5 624.76 926.5q-69.74 30-148.814 30Zm123.554-214L448 592.565V375.5h68.5v187L650 692l-50.5 50.5Z"/></svg>
                                <div>Recent</div>
                            </div>
                        </button>
                        <button class="hover:text-gray-50" on:click={() => {pauseSession(); dropdownOpen = false}}>
