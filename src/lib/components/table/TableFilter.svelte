...
<div class="z-30 flex items-center justify-between">
        ...
        <div class="relative flex items-center">
          ...
          >
            <svg
              ...
              ><path
                d="M420.5-101v-244.5H501v82.5h352.5v80.5H501v81.5h-80.5Zm-314-81.5V-263H375v80.5H106.5Zm188-177v-81h-188V-520h188v-83.5H375v244h-80.5Zm126-81V-520h433v79.5h-433Zm164.5-175V-860h80.5v81.5h188v80.5h-188v82.5H585ZM106.5-698v-80.5h433v80.5h-433Z"
              /></svg
            >
          </button>
          {#if filterMenu}
            <div class="absolute -left-2 top-9 z-40 h-44 w-96 rounded-sm bg-zinc-700 shadow-lg" bind:this={filterDiv}>
              <div class="flex items-center justify-between shadow-md">
                <div class="mx-2 my-1 flex items-center space-x-2">
                  ...
                  <button
                    class="border-b px-1 {filterTab === 'Bosses' ? 'border-zinc-200' : 'border-zinc-700 text-gray-400'}"
                    onclick={() => {
                      filterTab = "Bosses";
                    }}
                  >
                ...
                <div class="h-36 overflow-auto px-2 py-1 text-xs">
                  ...
                  <div class="flex flex-wrap">
                    {#each difficultyMap as difficulty (difficulty)}
                      <button
                        class="m-1 truncate rounded border border-gray-500 px-1 {$searchFilter.difficulty === difficulty
                          ? 'bg-gray-800'
                          : ''}"
                        onclick={() => {
                ...
                <div class="h-36 overflow-auto px-2 py-1 text-xs">
                  ...
                  <div class="flex flex-wrap">
                    {#each bossList as boss (boss)}
                      <button
                        class="m-1 truncate rounded border border-gray-500 p-1 {$searchFilter.bosses.has(boss)
                          ? 'bg-gray-800'
                          : ''}"
                        onclick={() => {
  ...
  <div class="flex items-center space-x-2">
    {#if selectMode && $selectedEncounters.size > 0}
      ...
      >
        <svg class="size-5 fill-zinc-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
          ><path
            d="M254.5-100q-39.181 0-65.841-26.366Q162-152.731 162-191.5v-549h-57.5v-91.333H332V-879h295.5v47H856v91.5h-57.5v549q0 38.019-27.034 64.759Q744.431-100 706-100H254.5ZM706-740.5H254.5v549H706v-549ZM356.5-269H431v-396.5h-74.5V-269Zm173 0H605v-396.5h-75.5V-269Zm-275-471.5v549-549Z"
          /></svg
        >
      </button>
    {/if}
    ...
    >
      <svg class="size-5 fill-zinc-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
        ><path
          d="M191-99.5q-37.744 0-64.622-26.878T99.5-191v-578q0-38.156 26.878-65.328Q153.256-861.5 191-861.5h578q15.545 0 34.773 8.5Q823-844.5 833-836l-71 71v-4H191v578h578v-330l92.5-92.5V-191q0 37.744-27.172 64.622T769-99.5H191ZM467-296 247-516l48-48.5 172.158 172 392.342-392 47 49.5L467-296Z"
        /></svg
      >
      ...
      <div class="relative mx-auto flex flex-col rounded-lg border-gray-700 bg-zinc-800 text-gray-400 shadow-md">
        ...
        <div id="modal" class="flex-1 space-y-6 overflow-y-auto overscroll-contain p-6">
          <div class="text-center">
            ...
            <button
              type="button"
              class="focus:outline-hidden mr-2 inline-flex items-center justify-center rounded-lg bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800"
            ...
            <button
              type="button"
              class="focus:outline-hidden inline-flex items-center justify-center rounded-lg bg-gray-800 bg-transparent px-5 py-2.5 text-center text-sm font-medium text-gray-400 hover:bg-zinc-700 hover:text-white focus:text-white"
              onclick={() => (deleteConfirm = false)}
            >
              No, cancel
            </button>
